...
class Job(Base):
    ...
    employment_type: Mapped[str] = mapped_column(String(50), nullable=True, default="")
    ...
    currency: Mapped[str] = mapped_column(String(10), nullable=True, default="")
    status: Mapped[str] = mapped_column(String(50), nullable=True, default="Nova")
    source: Mapped[str] = mapped_column(String(100), nullable=True, default="")
    job_url: Mapped[str] = mapped_column(String(500), nullable=True, default="")
    recruiter: Mapped[str] = mapped_column(String(200), nullable=True, default="")
